...
namespace Extensions {
        ...
        public static string FormatIntToString(this int number) {
            ...
            */
            if (number >= 1000000000) {
                return $"{(Mathf.Floor(number / 10000000f) / 100f).ToString("0.##", CultureInfo.InvariantCulture)}b";
            }
            else if (number >= 1000000) {
                return $"{(Mathf.Floor(number / 10000f) / 100f).ToString("0.##", CultureInfo.InvariantCulture)}m";
            }
            else if (number >= 1000) {
                return $"{(Mathf.Floor(number / 10f) / 100f).ToString("0.##", CultureInfo.InvariantCulture)}k";
            }
            else {
    ...
    public static class ETransformMethods {
        ...
        /// <summary>
        /// resets the Position and Rotation of gameObject
        /// </summary>
        /// <param name="transform"></param>
        /// <param name="baseObject"></param>
        public static void ResetPosRot(this Transform transform) {
