...
namespace Game.InputSystem {
    /// <summary>
    /// Base class for user input actions
    /// </summary>
    public static class PlayerInput {
        ...
        //keyboard
        public static UnityEvent<Vector2> OnPlayerInput = new UnityEvent<Vector2>();
        public static UnityEvent OnAnyKeyboardInput = new UnityEvent(),
            OnFirstInput = new UnityEvent();
