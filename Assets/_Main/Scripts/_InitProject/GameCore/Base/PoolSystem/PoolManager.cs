...
namespace Game.Core {
    public class PoolManager : MonoBehaviour {
        ...
        private void Awake() {
            ...
            SceneSystem.OnSceneStartLoading.AddListener(ClearScenePools);
        }
        ...
        public void CreateDontDestroyPool(GameObject prefab, int initialPoolSize, bool autoFill = true) {
        ...
        public void CreateScenePool(GameObject prefab, int initialPoolSize, Transform sceneTransform, bool autoFill = true) {
            int id = prefab.GetInstanceID();
        ...
        private void FillUpArrayBuffer(PoolArrayBuffer<ObjectInstance> buffer) {
            ...
            ObjectInstance[] addObjsArray = new ObjectInstance[AUTO_FILL_UP_ARRAY_ELEMENTS_COUNT];
            Transform holder = buffer.HolderTransform;
            for (int i = 0; i < AUTO_FILL_UP_ARRAY_ELEMENTS_COUNT; i++) {
