...
namespace Game.UI {
    ...
    public class VibroBtn : Button {
        public static event Action<HapticTypes> OnClick;
        ...
        public override void OnPointerDown(PointerEventData eventData) {
            ...
            if (UseAnimation && interactable) {
                ...
                _scaleTween.SafeKill();
                _scaleTween = transform.DOScale(_startScale * AnimationScale, AnimationTime)
                    .SetUpdate(true)
                    .SetLink(gameObject);
            }
        }
        ...
        public override void OnPointerUp(PointerEventData eventData) {
            ...
            if (UseAnimation && interactable) {
                ...
                _scaleTween.SafeKill();
                _scaleTween = transform.DOScale(_startScale, AnimationTime)
                    .SetUpdate(true)
                    .SetLink(gameObject);
            }
        }
