...
namespace Game.Audio {
    public class AudioManager : MonoBehaviour {
        ...
        public bool SoundsEnabled {
            set {
                SaveSystem.Instance.Data.SoundsEnabled = value;
                if (value) {
        ...
        public float SoundLevel {
            set {
                ...
                SaveSystem.Instance.Data.SoundLevelNormalized = value;
                if (value > 0) {
        ...
        public float MusicLevel {
            set {
                value = Mathf.Clamp01(value);
                SaveSystem.Instance.Data.MusicLevelNormalized = value;
                if (value > 0) {
        ...
        private void Start() {
            ...
            MusicLevel = save.MusicLevelNormalized;
            SoundLevel = save.SoundLevelNormalized;
            SoundsEnabled = save.SoundsEnabled;
        }
        ...
        /// </summary>
        public void PlaySingleShot(SoundAudioClip audioData, TweenCallback onPlayed, float pitch = 1f) {
            if (!_soundsEnabled || _soundsLevel == 0f) {
                return;
            }
        ...
        /// If false - no callbacks will be</br>
        /// </summary>
        public void PlaySingleShotAt(SoundAudioClip audioData, Vector3 worldPoint, TweenCallback onPlayed, float pitch = 1f) {
            if (!_soundsEnabled || _soundsLevel == 0f) {
                return;
            }
        ...
        public void ChangeMusic(SoundAudioClip toMusic, float fadeInOutDuration = -1f, TweenCallback onPlayedCallback = null) {
